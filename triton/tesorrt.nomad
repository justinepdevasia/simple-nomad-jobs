...
job "tensorrt" {
  ...
  group "back" {
    task "rtserver" {
      ...
      artifact {
        source      = "https://raw.githubusercontent.com/facebookarchive/models/master/resnet50/predict_net.pb"
        destination = "local/models/resnet50_netdef/1/model.netdef"
        mode        = "file"
      }
      artifact {
        source      = "https://raw.githubusercontent.com/facebookarchive/models/master/resnet50/init_net.pb"
